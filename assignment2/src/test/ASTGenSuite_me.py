...
EndIf.
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("x"),[],IntLiteral(0))],[If([(BinaryOp("<",Id("x"),IntLiteral(20)),[VarDecl(Id("a"),[],IntLiteral(10))],[Assign(Id("x"),BinaryOp("+",Id("x"),IntLiteral(1)))]),(BinaryOp(">",Id("x"),IntLiteral(20)),[VarDecl(Id("x"),[],IntLiteral(5))],[Break()])],([VarDecl(Id("x"),[],IntLiteral(6))],[Continue()]))]))])
...
EndIf.
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("x"),[],IntLiteral(0))],[If([(BinaryOp("<",Id("x"),IntLiteral(20)),[],[Assign(Id("x"),BinaryOp("+",Id("x"),IntLiteral(1)))]),(BinaryOp(">",Id("x"),IntLiteral(20)),[],[If([(BinaryOp(">",Id("x"),IntLiteral(50)),[],[Continue()])],([],[])),Break()]),(BinaryOp(">",Id("x"),IntLiteral(20)),[],[If([(BinaryOp(">",Id("x"),IntLiteral(50)),[],[Continue()])],([],[])),Break()]),(BinaryOp(">",Id("x"),IntLiteral(20)),[VarDecl(Id("a"),[1],ArrayLiteral([IntLiteral(1)]))],[Break(),If([(BinaryOp(">",Id("x"),IntLiteral(50)),[],[Continue()])],([],[]))])],([],[Continue()]))]))])
...
EndIf.
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("x"),[],IntLiteral(0))],[If([(BinaryOp("<",Id("x"),IntLiteral(20)),[],[Assign(Id("x"),BinaryOp("+",Id("x"),IntLiteral(1)))]),(BinaryOp(">",Id("x"),IntLiteral(20)),[],[If([(BinaryOp(">",Id("x"),IntLiteral(50)),[],[If([(BinaryOp("<",Id("x"),IntLiteral(30)),[],[Break()]),(BinaryOp(">",Id("x"),IntLiteral(50)),[VarDecl(Id("a"),[],IntLiteral(10))],[Assign(Id("x"),BinaryOp("+",Id("x"),IntLiteral(1)))])],([],[Assign(Id("x"),BinaryOp("-",Id("x"),IntLiteral(1)))]))])],([],[])),Continue(),Break()]),(BinaryOp(">",Id("x"),IntLiteral(20)),[],[If([(BinaryOp(">",Id("x"),IntLiteral(50)),[],[Continue()])],([],[])),Break()]),(BinaryOp(">",Id("x"),IntLiteral(20)),[],[Break(),If([(BinaryOp(">",Id("x"),IntLiteral(50)),[],[Continue()]),(BinaryOp("<",Id("x"),IntLiteral(80)),[],[Break()])],([],[]))])],([],[Continue()]))]))])
...
Body:
    ...
    EndWhile.
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([],[While(BinaryOp("&&",BinaryOp("&&",BinaryOp("<",Id("x"),IntLiteral(10)),BinaryOp("!=",Id("x"),IntLiteral(0))),CallExpr(Id("foo"),[Id("x"),Id("y")])),([VarDecl(Id("sum"),[],IntLiteral(0)),VarDecl(Id("a"),[3],None)],[Assign(Id("sum"),BinaryOp("+",Id("sum"),Id("x"))),While(BinaryOp("==",BinaryOp("%",Id("x"),IntLiteral(2)),IntLiteral(0)),([VarDecl(Id("k"),[],IntLiteral(0))],[Assign(Id("sum"),BinaryOp("-",Id("sum"),Id("x")))]))]))]))])
...
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("i"),[],None)],[Dowhile(([],[Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1)))]),BinaryOp("<",Id("i"),IntLiteral(20)))]))])
...
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("i"),[],None)],[For(Id("i"),IntLiteral(1),BinaryOp("<",Id("i"),IntLiteral(10)),IntLiteral(2),([VarDecl(Id("isEqual"),[],BooleanLiteral(True))],[For(Id("j"),IntLiteral(1),BinaryOp("<",Id("j"),IntLiteral(10)),IntLiteral(3),([],[CallStmt(Id("printLn"),[BinaryOp("*",Id("i"),Id("j"))])]))]))]))])
...
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("i"),[],None)],[For(Id("i"),IntLiteral(1),BinaryOp("&&",BinaryOp("<",Id("i"),IntLiteral(10)),BinaryOp("==",BinaryOp("%",Id("i"),IntLiteral(2)),IntLiteral(0))),BinaryOp("*",IntLiteral(2),IntLiteral(3)),([],[CallStmt(Id("printLn"),[Id("i")])]))]))])
...
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("i"),[],None)],[CallStmt(Id("foo"),[BinaryOp("+",IntLiteral(5),BinaryOp("\\",BinaryOp("*",IntLiteral(4),IntLiteral(3)),IntLiteral(5))),StringLiteral("string"),BooleanLiteral(True)])]))])
...
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("i"),[],None)],[CallStmt(Id("foo"),[BooleanLiteral(True),CallExpr(Id("incr"),[IntLiteral(5)]),CallExpr(Id("incr"),[IntLiteral(6)])])]))])
...
Body:
    ...
    EndWhile.
EndBody."""
        expect = Program([FuncDecl(Id("main"),[],([VarDecl(Id("arrA"),[2,3],ArrayLiteral([ArrayLiteral([IntLiteral(2),IntLiteral(3),IntLiteral(5)]),ArrayLiteral([IntLiteral(6),IntLiteral(7),IntLiteral(8)])])),VarDecl(Id("arrB"),[2,3],ArrayLiteral([ArrayLiteral([IntLiteral(2),IntLiteral(3),IntLiteral(5)]),ArrayLiteral([IntLiteral(6),IntLiteral(7),IntLiteral(8)])])),VarDecl(Id("isEqual"),[],BooleanLiteral(True)),VarDecl(Id("i"),[],IntLiteral(0)),VarDecl(Id("j"),[],None),VarDecl(Id("sum"),[],None)],[While(BinaryOp("<",Id("i"),IntLiteral(2)),([],[For(Id("j"),IntLiteral(0),BinaryOp("<",Id("j"),IntLiteral(3)),IntLiteral(1),([],[If([(BinaryOp("!=",ArrayCell(Id("arrA"),[Id("i"),Id("j")]),ArrayCell(Id("arrB"),[Id("i"),Id("j")])),[],[Assign(Id("isEqual"),BooleanLiteral(False)),Break()])],([],[]))])),Assign(Id("i"),BinaryOp("+",Id("i"),IntLiteral(1)))]))]))])
...
Body:
EndBody."""
        expect = Program([FuncDecl(Id("foo"),[VarDecl(Id("a"),[5],None),VarDecl(Id("c"),[],None),VarDecl(Id("b"),[6,7],None)],([],[])),FuncDecl(Id("foo1"),[VarDecl(Id("a"),[5],None),VarDecl(Id("c"),[],None),VarDecl(Id("b"),[6,7],None),VarDecl(Id("d"),[],None)],([],[])),FuncDecl(Id("main"),[],([],[]))])
...
Body:
    Var: k,m,n,o;
EndBody."""
        expect = Program([FuncDecl(Id("foo"),[VarDecl(Id("a"),[5],None),VarDecl(Id("c"),[],None)],([VarDecl(Id("x"),[],None),VarDecl(Id("y"),[],None),VarDecl(Id("z"),[],None)],[])),FuncDecl(Id("main"),[],([VarDecl(Id("k"),[],None),VarDecl(Id("m"),[],None),VarDecl(Id("n"),[],None),VarDecl(Id("o"),[],None)],[]))])
...
Var: arrB[2][3] = {{2,3,5},{6,7,8}};
EndBody."""
        expect = Program([FuncDecl(Id("foo"),[VarDecl(Id("a"),[5],None),VarDecl(Id("c"),[],None)],([],[])),FuncDecl(Id("main"),[],([VarDecl(Id("arrA"),[2,3],ArrayLiteral([ArrayLiteral([IntLiteral(2),IntLiteral(3),IntLiteral(5)]),ArrayLiteral([IntLiteral(6),IntLiteral(7),IntLiteral(8)])])),VarDecl(Id("arrB"),[2,3],ArrayLiteral([ArrayLiteral([IntLiteral(2),IntLiteral(3),IntLiteral(5)]),ArrayLiteral([IntLiteral(6),IntLiteral(7),IntLiteral(8)])]))],[]))])
...
EndBody."""
    ...
    def test_102_hex(self):
        input = """
Var: x = 0x12;
"""
        expect = Program([VarDecl(Id("x"),[],IntLiteral(18))])
        self.assertTrue(TestAST.checkASTGen(input, expect, 401))
        
    def test_103_oct(self):
        input = """
Var: x = 0o12;
"""
